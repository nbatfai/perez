...
*"The son of Judah is Perez."* The project called Perez allows to perform experiments to test several parameter settings. Each experiment is implemented as a separate git branch.
